...
document.getElementById('button02').addEventListener('click', function() {
  ...
  setTimeout(function() {
    ...
    if (selectedNumberId === generatedNumber.toString().padStart(2, '0')) {
      ...
      a.src = "https://res.cloudinary.com/dqrttxm5s/image/upload/v1692662142/win_efqmy5.jpg";
      resultElement.innerHTML =  message  + generatedFace.innerHTML;
      resultElement.style.color = "green";
    } else {
      a.src="https://res.cloudinary.com/dqrttxm5s/image/upload/v1692662100/lose01_x0smhu.jpg";
